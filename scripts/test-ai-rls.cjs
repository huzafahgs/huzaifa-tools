...
(async () => {
 ...
 for (const file of ['202609090001_accounts.sql','202609110001_ai_tools.sql']) await db.exec(fs.readFileSync(path.join(__dirname,'../supabase/migrations',file),'utf8'));
 ...
 equal((await db.query('select * from public.account_tool_catalog')).rows.length,105);
